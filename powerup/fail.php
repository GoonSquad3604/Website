<HTML>
	<HEAD>
		<TITLE>Goon Squad | Message Failed</TITLE>
	...
	<BODY bgcolor="black" onload="startScroll()">
		...
		<td>
		<H1 style="color: purple; font-size: 36pt; text-shadow: 4px 4px #404040;">GAME OVER</H1>
		<H2 style="color: purple; font-size: 24pt; text-shadow: 2px 2px #404040;">Team 3604</H2>
		</td><td>
		Your message walked into a Koopa and failed to send.</td></tr></table>
