<html>
	<head>
		...
		<img id="goonimg" src="img/logo.png"></img>
		<h1 id="fixed-title">Goon Squad</h1>
		<!--<h1 class="fixed-title">Goon Squad</h1>-->
	</head>
	<body>
	<p>hello my name is Chad</p>
	<p>hello my name is Murphy</p>
	...
	<span style="float: right; font-size: 36pt;">Team 3604</span>
